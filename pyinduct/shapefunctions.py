...
class PointFunction(ShapeFunction):
    """
    Test Function on specific point.
    ...
    def cure_interval(domain, **kwargs):
        ...
        Return:
            ...
            shapefunctions.
        """
        funcs = np.empty((len(domain),), dtype=PointFunction)
        funcs[0] = PointFunction(domain[0],
                                 domain[0],
                                 domain[1],
                                 half="left",
                                 left_border=True,
        ...
        funcs[-1] = PointFunction(domain[-2],
                                  domain[-2],
                                  domain[-1],
                                  half="right",
                                  right_border=True,
        ...
        for idx in range(1, len(domain) - 1):
            funcs[idx] = PointFunction(domain[idx - 1],
                                       domain[idx],
                                       domain[idx + 1],
                                       left_border=True if idx == 1 else False,
                                       right_border=True if idx == len(domain) - 2 else False,
